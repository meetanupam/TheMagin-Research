...
const data = {
  product: {
    ...
    intro: "Margin brings discovery, close reading, synthesis, and citation into one evidence-linked flow.",
    sections: [
  ...
  solutions: {
    ...
    intro: "From a first-year paper to a funded lab, Margin gives people the right depth without adding another complicated system.",
    sections: [
  ...
  about: {
    ...
    intro: "Margin exists because the most important part of research is not producing sentences. It is learning how evidence changes your mind.",
    sections: [
...
function Logo(){return <Link className="logo" href="/"><span className="logo-mark">M</span><span>margin</span></Link>}
...
function SimpleFooter(){return <footer><div className="footer-top"><div><Logo/><p>A calmer place to do serious thinking.</p></div><div className="footer-links"><div><b>Explore</b><Link href="/product">Product</Link><Link href="/solutions">Solutions</Link><Link href="/pricing">Pricing</Link></div><div><b>Contact</b><a href="mailto:hello@margin.study">hello@margin.study</a><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div></div></div><div className="footer-bottom"><span>© 2026 Margin Labs</span><span>Made for curious minds everywhere.</span></div></footer>}
