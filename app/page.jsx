...
const features = [
  { icon: Search, n: "01", title: "Search with a point of view", text: "Ask a research question. Margin finds the papers, explains why they matter, and keeps every claim linked to its source." },
...
const faqs = [
  ["Is Margin another AI essay writer?", "No. Margin is designed for the work before and around writing: discovering sources, reading critically, mapping evidence, and building a traceable argument. It never hides where a claim came from."],
  ["Can I import my existing papers?", "Yes. Add PDFs, DOI links, Zotero exports, lecture notes, and web sources. Margin deduplicates your library and preserves your folders and metadata."],
...
function Logo() {
  return <Link className="logo" href="/" aria-label="Margin home"><span className="logo-mark">M</span><span>margin</span></Link>;
}
...
function Footer() {
  return <footer>
    <div className="footer-top">
      ...
      <div className="footer-links"><div><b>Product</b><Link href="/product">How it works</Link><Link href="/pricing">Pricing</Link><Link href="/solutions">For universities</Link></div><div><b>Company</b><Link href="/about">Our thesis</Link><Link href="/about#principles">Principles</Link><a href="mailto:hello@margin.study">Contact</a></div><div><b>Legal</b><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link><Link href="/security">Security</Link></div></div>
    </div>
    <div className="footer-bottom"><span>© 2026 Margin Labs</span><span>Made for curious minds everywhere.</span></div>
  </footer>;
}
    ...
    <div className="app-ui">
      ...
      <div className="app-main">
        ...
        <div className="map-area">
          ...
          <div className="insight-card"><Sparkles/><div><small>MARGIN INSIGHT</small><b>Most studies measure performance, but only 3 examine perceived agency.</b><a>Explore this gap <ArrowRight/></a></div></div>
        </div>
      </div>
    </div>
  </div>;
  ...
  return <main>
    ...
    <section className="hero grid-bg">
      <div className="hero-copy">
        ...
        <p>Margin turns papers, notes, and questions into an evidence-linked workspace—so you can understand the field, find the gap, and write work that holds up.</p>
    ...
    <section className="problem section-pad">
      ...
      <div className="split-head"><h2>Your best ideas are buried under 37 open tabs.</h2><div><p>Research tools help you store information. AI tools help you generate text. Neither helps you build understanding.</p><p>Margin is the missing layer between reading and writing.</p></div></div>
      <div className="chaos-grid">
        <div className="chaos-before"><span>BEFORE MARGIN</span><div className="mess m1">PDF_final_v7.pdf</div><div className="mess m2">“interesting quote...”</div><div className="mess m3">where did I read this?</div><div className="mess m4">12 tabs</div><div className="mess m5">untitled notes</div></div>
        <div className="arrow-circle"><ArrowRight/></div>
        <div className="clarity-card"><span>WITH MARGIN</span><div className="mini-map"><i/><i/><i/><i/></div><h3>One connected argument.</h3><p>Every idea linked. Every source traceable.</p></div>
      </div>
    </section>
    ...
    <section className="proof section-pad">
      <div className="proof-card">
        <div className="quote-mark">“</div><blockquote>Margin didn’t write my thesis. It did something more useful—it showed me where my argument was thin before my supervisor did.</blockquote>
