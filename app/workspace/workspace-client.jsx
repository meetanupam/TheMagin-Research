...
function Mark() {
  return <Link className="ws-logo" href="/" aria-label="TheMagin home"><span>TM</span><b>TheMagin</b></Link>;
}
  ...
  return <div className="onboarding">
    <div className="onboarding-card">
      ...
      {step === 0 ? <>
        ...
        <p>A rough topic is enough. You can sharpen the research question inside TheMagin.</p>
